    ...
    <div class="panel p-6">
        ...
        @php
            $rows = [
                ...
                ['label'=>'Gender',     'value'=>($user->gender === 'Laki-laki' ? 'Male' : ($user->gender === 'Perempuan' ? 'Female' : 'Not set')), 'icon'=>'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'clr'=>($user->gender === 'Perempuan' ? 'pink' : 'sky')],
