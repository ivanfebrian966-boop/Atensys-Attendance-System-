...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="flex-1 overflow-y-auto pb-4 relative" style="z-index:1">
        ...
        <a href="/employee/dashboard" class="nav-item active" id="nav-dashboard">
        ...
        <a href="/employee/attendance" class="nav-item" id="nav-attendance">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/employee/history" class="nav-item" id="nav-history">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/employee/profile" class="nav-item" id="nav-profile">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="main-content">
        ...
        <div class="px-4 md:px-6 py-4 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <div class="topbar-profile">
                    <div class="topbar-avatar">{{ substr(Auth::user()->name, 0, 2) }}</div>
                    <div class="hidden sm:block">
                        <p class="text-sm font-semibold text-slate-800" style="font-family:'Sora',sans-serif">{{ Auth::user()->name }}</p>
                        <p class="text-xs text-slate-400">{{ Auth::user()->division ?? 'Employee' }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="p-4 md:p-6">
        ...
        <div class="welcome-card fade-up d1 mb-6">
            <div>
                <h2 class="text-xl md:text-2xl font-bold text-white" style="font-family:'Sora',sans-serif">Welcome back, {{ Auth::user()->name }}! 👋</h2>
