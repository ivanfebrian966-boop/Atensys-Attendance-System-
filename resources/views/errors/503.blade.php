...
<head>
    ...
    <title>503 Service Unavailable — ATTENSYS</title>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            .sliced-middle { font-size: 0.85rem; letter-spacing: 0.3em; }
        }
...
<body class="antialiased min-h-screen flex flex-col relative font-sans text-white opacity-0 animate-fade-in">
    ...
    <header id="navbar" class="fixed top-0 left-0 right-0 z-50 bg-transparent opacity-0 animate-fade-in delay-200">
        <div class="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
                <a href="{{ url('/') }}#features" class="text-white font-semibold hover:text-cyan-400 transition-colors">Features</a>
                <a href="{{ url('/') }}#howitworks" class="text-white font-semibold hover:text-cyan-400 transition-colors">How It Works</a>
                <a href="{{ url('/') }}#about" class="text-white font-semibold hover:text-cyan-400 transition-colors">About</a>
            </nav>
    ...
    <main class="flex-1 flex flex-col items-center justify-center w-full px-4 relative z-10 pt-20">
        ...
        <div class="sliced-text-container opacity-0 animate-slide-up delay-300">
            <div class="sliced-top">503</div>
            <div class="sliced-bottom">503</div>
            <!-- Invisible text to keep container size -->
            <div class="invisible">503</div>
