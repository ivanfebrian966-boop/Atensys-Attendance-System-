...
function closeModal(id){ document.getElementById(id).classList.remove('open'); document.body.style.overflow=''; clearAllErrors(); }
...
function setDate() {
    ...
    const n=new Date(); const el=document.getElementById('currentDate');
